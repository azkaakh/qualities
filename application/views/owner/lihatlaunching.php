...
<body>
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Data Launching</li>
                    </ul>
                </div>
                <!-- /Page Breadcrumb -->
                <!-- Page Header -->
                ...
                <?php
                  if($hasil == 'sukses') { ?>
                    ...
                    <div class="alert alert-success fade in" align="center">
                      ...
                      <strong>Sukses</strong> Sunting Data Launching Telah Berhasil
                    </div>
                  <?php } 
                  elseif ($hasil == 'gagal') { ?>
                    <br>
                    <div class="alert alert-danger fade in radius-bordered alert-shadowed">
                        ...
                        <strong>Gagal!</strong> Sunting Data Launching Gagal
                    </div>
                  <?php }
                ?>
                <div class="page-body">
                        ...
                        <div class="col-xs-12 col-md-12">
                            <div class="widget">
                                ...
                                <div class="widget-body">
                                    ...
                                    <form id="registrationForm" action="<?php echo base_url(); ?>launching/cetaklaunching" method="post" class="form-horizontal"
    ...
    <script type="text/javascript">
        ...
        function muatproject(){                    
                ...
                $.ajax({
                url: '<?php echo base_url(); ?>ajax/ambillistlaunching/',
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        var isi = '<tr><td>'+data[i].id_launching+'</td><td>'+ data[i].nama_kompl+'</td><td>'+ data[i].id_kompl +'</td><td>'+ data[i].qc_inspecl+'</td><td>'+ data[i].qa_coorl +'</td><td>'+ data[i].class_surl +'</td><td>'+ data[i].owner_surl +'</td><td>'+ data[i].status_launching +'</td><td><a class="btn btn-info btn-xs " onclick="lihatdetail(\''+ idproj2 +'\', \''+ data[i].id_launching +'\' )" data-toggle="modal" data-target="#myModal"><i class="fa fa-info"></i> Lihat Detail</a> <button class="btn btn-palegreen btn-xs" onclick="pilih(\''+ idproj2 +'\', \''+ data[i].id_launching +'\')"><i class="fa fa-print"></i> Cetak Data</button></td></tr>';
                    ...
                    $.ajax({
                        ...
                        success: function(data) {             
                            ...
                            for (var i = 0; i < data.length; i++) {
                                ...
                                var isi2 = '<tr><td><strong>'+ data[i].nama_iteml +'</strong></td><td>'+ data[i].isi_iteml+'</td></tr>';
                                $('#isidetail').append(isi2);
                            };
