...
<head>
    <meta charset="utf-8" />
    <title>Data Identifikasi Material</title>
...
<body>
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Data Identifikasi Material</li>
                    </ul>
                </div>
                <!-- /Page Breadcrumb -->
                <!-- Page Header -->
                        ...
                        <div class="col-xs-12 col-md-12">
                            <div class="widget">
                                ...
                                <div class="widget-body">
                                    ...
                                    <form id="registrationForm" action="<?php echo base_url(); ?>idenmat/cetakiden" method="post" class="form-horizontal"
                ...
                <div class="modal fade" id="myModal" role="dialog">
                    <div class="modal-dialog">
                      ...
                      <div class="modal-content">
                        ...
                        <form action="<?php echo base_url(); ?>idenmat/cetakiden" method="post">
                            <input id="namakomp" type="hidden" name="namakomp" value="aku" />
                        </form>
                        ...
                        <div class="modal-footer">
                          ...
                          <button type="submit" class="btn btn-default" data-dismiss="modal">Cetak</button>
                        </div>
                      </div>
    ...
    <script type="text/javascript">
        ...
        function pilih(idproj2, idenmat){
        ...
        function muatproject(){
            ...
            if (nilai != "null") {
                $.ajax({
                url: '<?php echo base_url(); ?>ajax/ambillistiden/',
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        var isi = '<tr><td>'+data[i].id_idenmat+'</td><td>'+ data[i].nama_komp+'</td><td>'+ data[i].id_komp+'</td><td>'+ data[i].qc_inspec+'</td><td>'+ data[i].qa_coor +'</td><td>'+ data[i].class_sur+'</td><td>'+ data[i].owner_sur+'</td><td>'+ data[i].status+'</td><td><a class="btn btn-info btn-xs " onclick="lihatdetail(\''+ idproj2 +'\', \''+ data[i].id_idenmat +'\' )" data-toggle="modal" data-target="#myModal"><i class="fa fa-info"></i> Lihat Detail</a> <button class="btn btn-palegreen btn-xs" type="submit" onclick="pilih(\''+ idproj2 +'\', \''+ data[i].id_idenmat +'\')"><i class="fa fa-print"></i> Cetak Data</button></td></tr>';
                    ...
                    $.ajax({
                        ...
                        success: function(data) {             
                            ...
                            for (var i = 0; i < data.length; i++) {
                                ...
                                var isi2 = '<tr><td><strong>'+ data[i].nama_item +'</strong></td><td>'+ data[i].isi_item+'</td></tr>';
                                $('#isidetail').append(isi2);
                            };
