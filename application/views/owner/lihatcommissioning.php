...
<head>
    <meta charset="utf-8" />
    <title>Data Commissioning</title>
...
<body>
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Data Commissioning</li>
                    </ul>
                </div>
                <!-- /Page Breadcrumb -->
                <!-- Page Header -->
                ...
                <?php
                  if($hasil == 'sukses') { ?>
                    ...
                    <div class="alert alert-success fade in" align="center">
                      ...
                      <strong>Sukses</strong> Sunting Data Commissioning Telah Berhasil
                    </div>
                  <?php } 
                  elseif ($hasil == 'gagal') { ?>
                    <br>
                    <div class="alert alert-danger fade in radius-bordered alert-shadowed">
                        ...
                        <strong>Gagal!</strong> Sunting Data Commissioning Gagal
                    </div>
                  <?php }
                ?>
                <div class="page-body">
                        ...
                        <div class="col-xs-12 col-md-12">
                            <div class="widget">
                                ...
                                <div class="widget-body">
                                    ...
                                    <form id="registrationForm" action="<?php echo base_url(); ?>comm/cetakcomm" method="post" class="form-horizontal"
    ...
    <script type="text/javascript">
        ...
        function muatproject(){
            ...
            if (nilai != "null") {
                $.ajax({
                url: '<?php echo base_url(); ?>ajax/ambillistcomm/',
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        var isi = '<tr><td>'+data[i].id_comm+'</td><td>'+ data[i].pengujian_comm+'</td><td>'+ data[i].id_kompom+'</td><td>'+ data[i].qc_inspecom+'</td><td>'+ data[i].qa_coorom +'</td><td>'+ data[i].class_surom+'</td><td>'+ data[i].owner_surom+'</td><td>'+ data[i].status_comm+'</td><td><a class="btn btn-info btn-xs " onclick="lihatdetail(\''+ idproj2 +'\', \''+ data[i].id_comm +'\' )" data-toggle="modal" data-target="#myModal"><i class="fa fa-info"></i> Lihat Detail</a> <button class="btn btn-palegreen btn-xs" onclick="pilih(\''+ idproj2 +'\', \''+ data[i].id_comm +'\')"><i class="fa fa-print"></i> Cetak Data</button></td></tr>';
                    ...
                    $.ajax({
                        ...
                        success: function(data) {             
                            ...
                            for (var i = 0; i < data.length; i++) {
                                ...
                                var isi2 = '<tr><td><strong>'+ data[i].nama_itemom +'</strong></td><td>'+ data[i].isi_itemom+'</td></tr>';
                                $('#isidetail').append(isi2);
                            };
