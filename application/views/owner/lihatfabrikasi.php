...
<body>
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Data Fabrikasi</li>
                    </ul>
                </div>
                <!-- /Page Breadcrumb -->
                <!-- Page Header -->
                        ...
                        <div class="col-xs-12 col-md-12">
                            <div class="widget">
                                ...
                                <div class="widget-body">
                                    ...
                                    <form id="registrationForm" action="<?php echo base_url(); ?>fabrikasi/cetakfabrikasi" method="post" class="form-horizontal"
    ...
    <script type="text/javascript">
        ...
        function muatproject(){
            ...
            if (nilai != "null") {
                $.ajax({
                url: '<?php echo base_url(); ?>ajax/ambillistfabrikasi/',
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        var isi = '<tr><td>'+data[i].id_fabrikasi+'</td><td>'+ data[i].nama_kompfab+'</td><td>'+ data[i].id_kompfab+'</td><td>'+ data[i].qc_inspecfab+'</td><td>'+ data[i].qa_coorfab +'</td><td>'+ data[i].class_surfab+'</td><td>'+ data[i].owner_surfab+'</td><td>'+ data[i].status_fab+'</td><td><a class="btn btn-info btn-xs " onclick="lihatdetail(\''+ idproj2 +'\', \''+ data[i].id_fabrikasi +'\' )" data-toggle="modal" data-target="#myModal"><i class="fa fa-info"></i> Lihat Detail</a> <button class="btn btn-palegreen btn-xs" onclick="pilih(\''+ idproj2 +'\', \''+ data[i].id_fabrikasi +'\')"><i class="fa fa-print"></i> Cetak Data</button></td></tr>';
                    ...
                    $.ajax({
                        ...
                        success: function(data) {             
                            ...
                            for (var i = 0; i < data.length; i++) {
                                ...
                                var isi2 = '<tr><td><strong>'+ data[i].nama_itemfab +'</strong></td><td>'+ data[i].isi_itemfab+'</td></tr>';
                                $('#isidetail').append(isi2);
                            };
