...
<body onload="muatproject()">
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Data Delivery</li>
                    </ul>
                </div>
                <!-- /Page Breadcrumb -->
                <!-- Page Header -->
                ...
                <?php
                  if($hasil == 'sukses') { ?>
                    ...
                    <div class="alert alert-success fade in" align="center">
                      ...
                      <strong>Sukses</strong> Sunting Data Delivery Telah Berhasil
                    </div>
                  <?php } 
                  elseif ($hasil == 'gagal') { ?>
                    <br>
                    <div class="alert alert-danger fade in radius-bordered alert-shadowed">
                        ...
                        <strong>Gagal!</strong> Sunting Data Delivery Gagal
                    </div>
                  <?php }
                ?>
                <div class="page-body">
                        ...
                        <div class="col-xs-12 col-md-12">
                            <div class="widget">
                                ...
                                <div class="widget-body">
                                    ...
                                    <form id="registrationForm" action="<?php echo base_url(); ?>delivery/cetakdelivery" method="post" class="form-horizontal"
    ...
    <script type="text/javascript">
        ...
        function muatproject(){                    
                ...
                $.ajax({
                url: '<?php echo base_url(); ?>ajax/ambillistdelivery/',
                data: {idproj:idproj},
                dataType: 'json',
                type: 'POST',
                success: function(data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        var isi = '<tr><td>'+data[i].id_delivery+'</td><td>'+ data[i].nama_dokumen +'</td><td>'+ data[i].qc_inspecd+'</td><td>'+ data[i].qa_coord +'</td><td>'+ data[i].class_surd +'</td><td>'+ data[i].owner_surd +'</td><td>'+ data[i].status_delivery +'</td><td><a class="btn btn-info btn-xs " onclick="lihatdetail(\''+ idproj2 +'\', \''+ data[i].id_delivery +'\' )" data-toggle="modal" data-target="#myModal"><i class="fa fa-info"></i> Lihat Detail</a> <button class="btn btn-palegreen btn-xs" onclick="pilih(\''+ idproj2 +'\', \''+ data[i].id_delivery +'\')"><i class="fa fa-print"></i> Cetak Data</button></td></tr>';
                    ...
                    $.ajax({
                        ...
                        success: function(data) {             
                            ...
                            for (var i = 0; i < data.length; i++) {
                                ...
                                var isi2 = '<tr><td><strong>'+ data[i].nama_itemd +'</strong></td><td>'+ data[i].isi_itemd+'</td></tr>';
                                $('#isidetail').append(isi2);
                            };
