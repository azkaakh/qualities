...
<body onload="muatproject()">
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Data Erection</li>
                    </ul>
                </div>
                <!-- /Page Breadcrumb -->
                <!-- Page Header -->
                ...
                <?php
                  ...
                  elseif ($hasil == 'gagal') { ?>
                    ...
                    <div class="alert alert-danger fade in radius-bordered alert-shadowed">
                        ...
                        <strong>Gagal!</strong> Sunting Data Erection Gagal
                    </div>
                  <?php }
                ?>
                <div class="page-body">
                        ...
                        <div class="col-xs-12 col-md-12">
                            <div class="widget">
                                ...
                                <div class="widget-body">
                                    ...
                                    <form id="registrationForm" action="<?php echo base_url(); ?>erection/cetakerection" method="post" class="form-horizontal"
    ...
    <script type="text/javascript">
        ...
        function muatproject(){                    
                ...
                $.ajax({
                url: '<?php echo base_url(); ?>ajax/ambillisterection/',
                data: {idproj:idproj},
                dataType: 'json',
                type: 'POST',
                success: function(data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        var isi = '<tr><td>'+data[i].id_erection+'</td><td>'+ data[i].proses_erection+'</td><td>'+ data[i].blok_erection+'</td><td>'+ data[i].qc_inspecer+'</td><td>'+ data[i].qa_coorer +'</td><td>'+ data[i].class_surrer+'</td><td>'+ data[i].owner_surer+'</td><td>'+ data[i].status_erection+'</td><td><a class="btn btn-info btn-xs " onclick="lihatdetail(\''+ idproj2 +'\', \''+ data[i].id_erection +'\' )" data-toggle="modal" data-target="#myModal"><i class="fa fa-info"></i> Lihat Detail</a> <button class="btn btn-palegreen btn-xs" onclick="pilih(\''+ idproj2 +'\', \''+ data[i].id_erection +'\')"><i class="fa fa-print"></i> Cetak Data</button></td></tr>';
                    ...
                    $.ajax({
                        ...
                        success: function(data) {             
                            ...
                            for (var i = 0; i < data.length; i++) {
                                ...
                                var isi2 = '<tr><td><strong>'+ data[i].nama_itemer +'</strong></td><td>'+ data[i].isi_itemer+'</td></tr>';
                                $('#isidetail').append(isi2);
                            };
