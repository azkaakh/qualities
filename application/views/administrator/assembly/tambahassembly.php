                            ...
                            <div class="widget">
                                ...
                                <div class="widget-body">
                                    ...
                                    <div id="horizontal-form">
                                                <form class="form-horizontal" method="post" role="form" enctype="multipart/form-data" action="<?php echo base_url(); ?>assembly/submitassembly">
...
<!-- 
                                                    ...
                                                    <input id="id_assembly" type="hidden" name="id_assembly"  value="<?php echo $id;?>" />
