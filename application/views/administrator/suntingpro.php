...
<body onload="ambilproject()">
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Project <?php echo $this->session->userdata('pilihan_project'); ?></li>
                    </ul>
                </div>
                <!-- /Page Breadcrumb -->
                <!-- Page Header -->
                    ...
                    <div class="header-title">
                        <h1>
                            ...
                            <small>
                                ...
                                Project <?php echo $this->session->userdata('pilihan_project'); ?>
                            </small>
                        </h1>
                    </div>
                    <!--Header Buttons-->
                ...
                <?php
                  if($hasil == 'sukses') { ?>
                    ...
                    <div class="alert alert-success fade in" align="center">
                      ...
                      <strong>Sukses</strong> Update Data Project Telah Berhasil
                    </div>
                  <?php } 
                  elseif ($hasil == 'gagal') { ?>
                    <br>
                    <div class="alert alert-danger fade in radius-bordered alert-shadowed">
                        ...
                        <strong>Gagal!</strong> Update Data Project Gagal
                    </div>
                  <?php }
                ?>
                <div class="page-body">
                            ...
                            <div class="widget">
                                ...
                                <div class="widget-body">
                                    ...
                                    <div id="horizontal-form">
                                                <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>project/updateproject" id="form" name="form" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input type="text" class="form-control" id="nopro" name="nopro" placeholder="No Project" disabled="true">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input type="date" class="form-control" id="comm" name="comm" placeholder="Commissioning Progress">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            <input type="hidden" class="form-control" id="idproj" name="idproj" placeholder="Delivery" value="<?php echo $this->session->userdata('pilihan_project'); ?>">
                                                        </div>
                                                    </div>
    ...
    <script type="text/javascript">
        function ambilproject(){
            var id = '<?php echo $this->session->userdata('pilihan_project'); ?>';
            $.ajax({
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        document.getElementById('nopro').value = data[i].id_project;
                        document.getElementById('namapro').value = data[i].nama_project;
                        document.getElementById('owner').value = data[i].owner;
                        document.getElementById('imo').value = data[i].imo;
                        document.getElementById('panjang').value = data[i].panjang_kapal;
                        document.getElementById('lebar').value = data[i].lebar_kapal;
                        document.getElementById('tinggi').value = data[i].tinggi_kapal;
                        document.getElementById('sarat').value = data[i].sarat_kapal;
                        document.getElementById('gtflag').value = data[i].gt_flag;
                        document.getElementById('keel').value = data[i].keel_laying;
                        document.getElementById('launching').value = data[i].launching;
                        document.getElementById('comm').value = data[i].comm_prog;
                        document.getElementById('inclining').value = data[i].inclining;
                        document.getElementById('seatrial').value = data[i].sea_trial;
                        document.getElementById('delivery').value = data[i].delivery;
