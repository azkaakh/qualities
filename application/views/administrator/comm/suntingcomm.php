                ...
                <?php
                  if($hasil == 'sukses') { ?>
                    ...
                    <div class="alert alert-success fade in" align="center">
                      ...
                      <strong>Sukses</strong> Input Data Commissioning Telah Berhasil
                    </div>
                  <?php } 
                  elseif ($hasil == 'gagal') { ?>
                    <br>
                    <div class="alert alert-danger fade in radius-bordered alert-shadowed">
                        ...
                        <strong>Gagal!</strong> Input Data Commissioning Gagal
                    </div>
                  <?php }
                ?>
                <div class="page-body">
                        ...
                        <div class="col-xs-12 col-md-12">
                            <div class="widget">
                                <div class="widget-header ">
                                    <span class="widget-caption">Tahapan Commissioning</span>
                                ...
                                <div class="widget-body">
                                    ...
                                    <div id="horizontal-form">
                                                <form class="form-horizontal" method="post" role="form" enctype="multipart/form-data" action="<?php echo base_url(); ?>comm/updateisicomm">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="inputEmail3" class="col-sm-3 control-label no-padding-right">Nama Pengujian</label>
                                                        <div class="col-sm-6">
                                                            <input type="text" class="form-control" id="namauji1" name="namauji1" placeholder="Nama Komponen" disabled="true">
                                                            <input type="hidden" class="form-control" id="namauji" name="namauji" placeholder="Nama Komponen">                                                         
                                                        </div>
                                                    </div>
...
<!-- 
                                                    ...
                                                    <input id="idcom" type="hidden" name="idcom"  value="<?php echo $idenparsing;?>" />
                    ...
                    <div class="modal-dialog">
                      ...
                      <div class="modal-content">
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title">Penambahan Data Commissioning</h4>
                        </div>
                        <div class="modal-body">
                          <p>Pastikan Anda telah memasukkan data pada Commissioning terlebih dahulu</p>
                        </div>
                ...
                <div class="modal fade" id="off" role="dialog">
                    <div class="modal-dialog">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <p>Data Blok belum ada dalam Database, silahkan isi pada Commissioning terlebih dahulu.</p>
                        </div>
                        <div class="modal-footer">
                          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                        </div>
           ...
           $.ajax({
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        document.getElementById('bagian1').value = data[i].bagian_comm; 
                        document.getElementById('bagian').value = data[i].bagian_comm;
                        document.getElementById('namauji1').value = data[i].pengujian_comm; 
                        document.getElementById('namauji').value = data[i].pengujian_comm; 
                        document.getElementById('idkomp').value = data[i].id_kompom;
                        document.getElementById('qcinspec').value = data[i].qc_inspecom;
                        document.getElementById('qacoor').value = data[i].qa_coorom;
                        document.getElementById('classsur').value = data[i].class_surom;
                        document.getElementById('ownersur').value = data[i].owner_surom;
                        document.getElementById('tanggalperiksa').value = data[i].tgl_periksaom;
                        document.getElementById('status').value = data[i].status_comm;
                        ...
                        if(data[i].status_comm == "Reject"){
                            ...
                            document.getElementById('rein').innerHTML = '<label for="inputEmail3" class="col-sm-3 control-label no-padding-right">Tanggal Re Inspeksi</label><div class="col-sm-6"><input type="text" class="form-control" id="reinspek1" name="reinspek1" value="'+ data[i].tgl_reinspeksiom +'" disabled="true"><input type="hidden" class="form-control" id="reinspek" name="reinspek" value="'+ data[i].tgl_reinspeksiom +'"></div>';
                            document.getElementById('rekomendasi').innerHTML = '<label for="inputEmail3" class="col-sm-3 control-label no-padding-right">Rekomendasi</label><div class="col-sm-6"><textarea class="form-control" id="rekomendasi" name="rekomendasi" placeholder="Masukkan Rekomendasi">'+ data[i].rekomendasi_comm +'</textarea></div>'; 
                    ...
                    $.ajax({
                        ...
                        success: function(data) {             
                            ...
                            for (var i = 0; i < data.length; i++) {
                                ...
                                var id1 = i + '1';
                                var id2 = i + '2';
                                itemlist[i] = data[i].nama_itemom;
                                var isi = '<div class="form-group"><label class="col-sm-3 control-label no-padding-right">'+ data[i].nama_itemom+'</label><div class="col-lg-3"><input type="text" class="form-control" value="'+ data[i].isi_itemom+'" id="'+ id1 +'" placeholder="isi Item"></div><div class="col-lg-3"><input type="text" class="form-control" value="'+ data[i].standard_itemom +'" id="'+ id2 +'" placeholder="Standard Item"></div></div> ';
                                $('#itemisi').append(isi);
