                            ...
                            <div class="widget">
                                ...
                                <div class="widget-body">
                                    ...
                                    <div id="horizontal-form">
                                                <form class="form-horizontal" method="post" role="form" enctype="multipart/form-data" action="<?php echo base_url(); ?>comm/submitcomm">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input type="text" class="form-control" id="namauji" name="namauji" placeholder="Nama Komponen">                                                         
                                                        </div>
                                                    </div>
...
<!-- 
                                                    ...
                                                    <input id="idcom" type="hidden" name="idcom"  value="<?php echo $id;?>" />
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $(function () {
                $( "#namauji" ).autocomplete({
                    source: function(request, response) {                        
                        var bagian = document.getElementById('bagian').value;
                        $.ajax({ 
                            url: "<?php echo base_url(); ?>ajax/ambilcomm/",
                            data: { kode: $("#namauji").val(), bagian:bagian},
                            dataType: "json",
                            type: "POST",
                    ...
                    select: function(event, ui){
                        ...
                        var bagian = document.getElementById('bagian').value;
                        $.ajax({
                        url: '<?php echo base_url(); ?>ajax/ambilitemcom/',
                        ...
                        success: function(data) {
                            ...
                            for (var i = 0; i < data.length; i++) {
                                var id1 = i + '1';
                                var id2 = i + '2';
                                itemlist[i] = data[i].item_comm;
                                var isi = '<div class="form-group"><label class="col-sm-3 control-label no-padding-right">'+ data[i].item_comm+'</label><div class="col-lg-3"><input type="'+data[i].tipe_datacomm  +'" class="form-control" id="'+ id1 +'" placeholder="isi Item"></div><div class="col-lg-3"><input type="'+ data[i].tipe_datacomm +'" class="form-control" id="'+ id2 +'" placeholder="Standard Item"></div></div>';
                                $('#itemisi').append(isi);
