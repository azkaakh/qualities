                ...
                <?php
                  if($hasil == 'sukses') { ?>
                    ...
                    <div class="alert alert-success fade in" align="center">
                      ...
                      <strong>Sukses</strong> Input Data Erection Telah Berhasil
                    </div>
                  <?php } 
                  elseif ($hasil == 'gagal') { ?>
                    <br>
                            ...
                            <div class="widget">
                                ...
                                <div class="widget-body">
                                    ...
                                    <div id="horizontal-form">
                                                <form class="form-horizontal" method="post" role="form" enctype="multipart/form-data" action="<?php echo base_url(); ?>erection/submiterection">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input type="text" class="form-control" id="namablok" name="namablok" placeholder="Nama Blok" onchange="ceknama()">                                                         
                                                        </div>
                                                    </div>
...
<!-- 
                                                    ...
                                                    <input id="id_erection" type="hidden" name="id_erection"  value="<?php echo $id;?>" />
    ...
    <script type="text/javascript">
        ...
        function firstload(){
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>ajax/ambilproseserection/',
                data: {},
                dataType: 'json',
                type: 'POST',
                success: function(data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        $('#proses').append($('<option>', {
                            value: data[i].proses_erection,
                            text: data[i].proses_erection
                        }));
        ...
        $(document).ready(function () {
            $(function () {
                $( "#namablok" ).autocomplete({
                    source: function(request, response) {                        
                        var idproj = '<?php echo $this->session->userdata('pilihan_project');?>';
                        $.ajax({ 
                            url: "<?php echo base_url(); ?>ajax/ambilnamaassembly/",
                            data: { kode: $("#namablok").val(), idproj:idproj},
                            dataType: "json",
                            type: "POST",
                            success: function(data){
                                response(data);
        ...
        function ceknama () {
            var nama = document.getElementById('namablok').value;
            
            $.ajax({
                url: '<?php echo base_url(); ?>ajax/ceknamaas/',
                data: {nama:nama},
                dataType: 'json',
                type: 'POST',
                success: function(data) {
        ...
        function tampilproses(){        
            ...
            if (proses != "null") {
                $.ajax({
                url: '<?php echo base_url(); ?>ajax/ambilitemerection/',
                data: {proses:proses},
                dataType: 'json',
                type: 'POST',
                success: function(data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        var id1 = i + '1';
                        var id2 = i + '2';
                        itemlist[i] = data[i].item_erection;
                        var isi = '<div class="form-group"><label class="col-sm-3 control-label no-padding-right">'+ data[i].item_erection+'</label><div class="col-lg-3"><input type="'+data[i].tipe_dataer  +'" class="form-control" id="'+ id1 +'" placeholder="isi Item"></div><div class="col-lg-3"><input type="'+ data[i].tipe_dataer +'" class="form-control" id="'+ id2 +'" placeholder="Standard Item"></div></div>';
                        $('#itemisi').append(isi);
