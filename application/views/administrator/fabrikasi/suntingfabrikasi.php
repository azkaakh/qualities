                ...
                <?php
                  if($hasil == 'sukses') { ?>
                    ...
                    <div class="alert alert-success fade in" align="center">
                      ...
                      <strong>Sukses</strong> Sunting Data Fabrikasi Telah Berhasil
                    </div>
                  <?php } 
                  elseif ($hasil == 'gagal') { ?>
                    <br>
                    <div class="alert alert-danger fade in radius-bordered alert-shadowed">
                        ...
                        <strong>Gagal!</strong> Sunting Data Fabrikasi Gagal
                    </div>
                  <?php }
                ?>
                <div class="page-body">
                            ...
                            <div class="widget">
                                ...
                                <div class="widget-body">
                                    ...
                                    <div id="horizontal-form">
                                                <form class="form-horizontal" method="post" role="form" enctype="multipart/form-data" action="<?php echo base_url(); ?>fabrikasi/updatefabrikasi">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="inputEmail3" class="col-sm-3 control-label no-padding-right">Nama Bagian</label>
                                                        <div class="col-sm-6">
                                                            <input type="text" class="form-control" id="bagian1" name="bagian1" placeholder="Nama bagian" disabled="true">
                                                            <input type="hidden" class="form-control" id="bagian" name="bagian" placeholder="Nama bagian">                                                         
                                                        </div>
                                                    </div>
...
<!-- 
                                                    ...
                                                    <input id="id_fabrikasi" type="hidden" name="id_fabrikasi"  value="<?php echo $idenparsing;?>" />
    ...
    <script type="text/javascript">
        ...
        function firstload(){
           ...
           $.ajax({
                url: '<?php echo base_url(); ?>ajax/ambilulangfab/',
                data: {bagian:bagian, idproj:idproj, id_iden:id_iden},
                dataType: 'json',
                type: 'POST',
                success: function(data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        document.getElementById('bagian').value = data[i].bagian_fabrikasi;
                        document.getElementById('bagian1').value = data[i].bagian_fabrikasi;
                        document.getElementById('proses1').value = data[i].proses_fabrikasi;
                        document.getElementById('proses').value = data[i].proses_fabrikasi;
                        document.getElementById('namakomp').value = data[i].nama_kompfab;
                        document.getElementById('idkomp').value = data[i].id_kompfab;
                        document.getElementById('qcinspec').value = data[i].qc_inspecfab;
                        document.getElementById('qacoor').value = data[i].qa_coorfab;
                        document.getElementById('classsur').value = data[i].class_surfab;
                        document.getElementById('ownersur').value = data[i].owner_surfab;
                        document.getElementById('tanggalperiksa').value = data[i].tgl_periksafab;
                        document.getElementById('status').value = data[i].status_fab;
                        ...
                        if(data[i].status_fab == "Reject"){
                            ...
                            document.getElementById('rein').innerHTML = '<label for="inputEmail3" class="col-sm-3 control-label no-padding-right">Tanggal Re Inspeksi</label><div class="col-sm-6"><input type="text" class="form-control" id="reinspek1" name="reinspek1" value="'+ data[i].tgl_reinspeksifab +'" disabled="true"><input type="hidden" class="form-control" id="reinspek" name="reinspek" value="'+ data[i].tgl_reinspeksifab +'"></div>';
                            document.getElementById('rekomendasi').innerHTML = '<label for="inputEmail3" class="col-sm-3 control-label no-padding-right">Rekomendasi</label><div class="col-sm-6"><textarea class="form-control" id="rekomendasi" name="rekomendasi" placeholder="Masukkan Rekomendasi">'+ data[i].rekomendasi_fab +'</textarea></div>'; 
                    ...
                    $.ajax({
                        ...
                        success: function(data) {             
                            ...
                            for (var i = 0; i < data.length; i++) {
                                ...
                                var id1 = i + '1';
                                var id2 = i + '2';
                                itemlist[i] = data[i].nama_itemfab;
                                var isi = '<div class="form-group"><label class="col-sm-3 control-label no-padding-right">'+ data[i].nama_itemfab+'</label><div class="col-lg-3"><input type="text" class="form-control" value="'+ data[i].isi_itemfab+'" id="'+ id1 +'" placeholder="isi Item"></div><div class="col-lg-3"><input type="text" class="form-control" value="'+ data[i].standard_itemfab +'" id="'+ id2 +'" placeholder="Standard Item"></div></div> ';
                                $('#itemisi').append(isi);
