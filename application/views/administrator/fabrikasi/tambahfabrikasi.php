                ...
                <?php
                  if($hasil == 'sukses') { ?>
                    ...
                    <div class="alert alert-success fade in" align="center">
                      ...
                      <strong>Sukses</strong> Input Data Fabrikasi Telah Berhasil
                    </div>
                  <?php } 
                  elseif ($hasil == 'gagal') { ?>
                    <br>
                    <div class="alert alert-danger fade in radius-bordered alert-shadowed">
                        ...
                        <strong>Gagal!</strong> Input Data Fabrikasi Gagal
                    </div>
                  <?php }
                ?>
                <div class="page-body">
                        ...
                        <div class="col-xs-12 col-md-12">
                            <div class="widget">
                                <div class="widget-header ">
                                    <span class="widget-caption">Tahapan Fabrikasi</span>
                                ...
                                <div class="widget-body">
                                    ...
                                    <div id="horizontal-form">
                                                <form class="form-horizontal" method="post" role="form" enctype="multipart/form-data" action="<?php echo base_url(); ?>fabrikasi/submitfabrikasi">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="inputEmail3" class="col-sm-3 control-label no-padding-right">Bagian Fabrikasi</label>
                                                        <div class="col-sm-8">
                                                            <select id="bagian" name="bagian" onchange="tampilkomponen()">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="inputEmail3" class="col-sm-3 control-label no-padding-right">Proses</label>
                                                        <div class="col-sm-8">
                                                            <select id="proses" name="proses" onchange="tampilproses()">
                                                                <option value="null">--Silahkan Pilih--</option>
                                                                <!-- <option value="Pipe">Pipe</option>
                                                                <option value="Profil">Profil</option>
                                                                <option value="Pelat">Plat</option> -->
                                                            </select>                                                           
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input type="text" class="form-control" id="namakomp" name="namakomp" placeholder="Nama Komponen" onchange="ceknama()">                                                         
                                                        </div>
                                                    </div>
...
<!-- 
                                                    ...
                                                    <input id="id_fabrikasi" type="hidden" name="id_fabrikasi"  value="<?php echo $id;?>" />
                    ...
                    <div class="modal-dialog">
                      ...
                      <div class="modal-content">
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title">Penambahan Data Fabrikasi</h4>
                        </div>
                        <div class="modal-body">
                          <p>Pastikan Anda telah memasukkan data pada Identifikasi Material terlebih dahulu</p>
                        </div>
                ...
                <div class="modal fade" id="off" role="dialog">
                    <div class="modal-dialog">
                      ...
                      <div class="modal-content">
                        <div class="modal-header">
                          <button type="button" class="close" data-dismiss="modal">&times;</button>
                          <h4 class="modal-title">Komponen Belum Terdata</h4>
                        </div>
                        <div class="modal-body">
                          <p>Data Komponen / Outfitting belum ada dalam Database, silahkan isi pada Identifikasi Material.</p>
                        </div>
                        <div class="modal-footer">
                          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                        </div>
    ...
    <script type="text/javascript">
        ...
        function tampilkomponen(){
            ...
            if(nilai == "null"){
                document.getElementById('isikomponen').innerHTML='';
            }
            else if(nilai == "Hull Construction"){
               // document.getElementById('isikomponen').innerHTML = '<div class="form-group"><label for="inputEmail3" class="col-sm-3 control-label no-padding-right">Jenis Komponen</label><div class="col-sm-8"><select id="jenis" name="jenis"><option value="null">--Silahkan Pilih--</option><option value="Pipe">Pipe</option><option value="Profil">Profil</option><option value="Pelat">Plat</option></select></div></div><div class="form-group"><label for="inputEmail3" class="col-sm-3 control-label no-padding-right">Nama Komponen</label><div class="col-sm-6"><input type="text" class="form-control" id="namakomp" name="namakomp" placeholder="Nama Komponen"></div></div><div class="form-group"><label for="inputEmail3" class="col-sm-3 control-label no-padding-right">ID Komponen</label><div class="col-sm-6"><input type="text" class="form-control" id="idkomp" name="idkomp" placeholder="ID Komponen"> </div></div>';
                document.getElementById('isikomponen').innerHTML = '<div class="form-group"><label for="inputEmail3" class="col-sm-3 control-label no-padding-right">Jenis Komponen</label><div class="col-sm-8"><select id="jenis" name="jenis"><option value="null">--Silahkan Pilih--</option><option value="Pipe">Pipe</option><option value="Profil">Profil</option><option value="Pelat">Plat</option></select></div></div>';
            }
            else{
                //document.getElementById('isikomponen').innerHTML = '<input type="hidden" class="form-control" value="none" id="jenis" name="jenis"><div class="form-group"><label for="inputEmail3" class="col-sm-3 control-label no-padding-right">Nama Outfitting</label><div class="col-sm-6"><input type="text" class="form-control" id="namakomp" name="namakomp" placeholder="Nama Komponen"></div></div><div class="form-group"><label for="inputEmail3" class="col-sm-3 control-label no-padding-right">ID Komponen</label><div class="col-sm-6"><input type="text" class="form-control" id="idkomp" name="idkomp" placeholder="ID Komponen"> </div></div>';
                document.getElementById('isikomponen').innerHTML = '<input type="hidden" class="form-control" value="none" id="jenis" name="jenis">';
            }

            $.ajax({
                url: '<?php echo base_url(); ?>ajax/ambilprosesfabrikasi/',
                data: {nilai:nilai},
                dataType: 'json',
                type: 'POST',
                success: function(data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        $('#proses').append($('<option>', {
                            value: data[i].proses_fabrikasi,
                            text: data[i].proses_fabrikasi
                        }));
        ...
        function tampilproses(){
            ...
            if (proses != "null") {
                $.ajax({
                url: '<?php echo base_url(); ?>ajax/ambilitemfabrikasi/',
                data: {bagian:bagian , proses:proses},
                dataType: 'json',
                type: 'POST',
                success: function(data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        var id1 = i + '1';
                        var id2 = i + '2';
                        itemlist[i] = data[i].item_fabrikasi;
                        var isi = '<div class="form-group"><label class="col-sm-3 control-label no-padding-right">'+ data[i].item_fabrikasi+'</label><div class="col-lg-3"><input type="'+data[i].tipe_datafabrikasi  +'" class="form-control" id="'+ id1 +'" placeholder="isi Item"></div><div class="col-lg-3"><input type="'+ data[i].tipe_datafabrikasi +'" class="form-control" id="'+ id2 +'" placeholder="Standard Item"></div></div> ';
                        $('#itemisi').append(isi);
            ...
            $(function () {
                $( "#namakomp" ).autocomplete({
                    source: function(request, response) {
                        ...
                        $.ajax({ 
                            url: "<?php echo base_url(); ?>ajax/ambilnamakomp/",
                            data: { kode: $("#namakomp").val(), bagian:bagian, idproj:idproj},
                            dataType: "json",
                            type: "POST",
                            success: function(data){
                                response(data);
        ...
        function ceknama () {
            var nama = document.getElementById('namakomp').value;
            
            $.ajax({
                url: '<?php echo base_url(); ?>ajax/ceknamaiden/',
                data: {nama:nama},
                dataType: 'json',
                type: 'POST',
                success: function(data) {
