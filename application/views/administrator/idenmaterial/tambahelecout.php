            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Electric Outfitting</li>
                    </ul>
                </div>
                <!-- /Page Breadcrumb -->
                <!-- Page Header -->
                        ...
                        <div class="col-xs-12 col-md-12">
                            <div class="widget">
                                <div class="widget-header ">
                                    <span class="widget-caption">Identifikasi Material Electric Outfitting</span>
                                ...
                                <div class="widget-body">
                                    ...
                                    <div id="horizontal-form">
                                                <form class="form-horizontal" method="post" role="form" enctype="multipart/form-data" action="<?php echo base_url(); ?>idenmat/submitidentifikasi">
                                                    ...
                                                    <input type="hidden" class="form-control" id="bagian" name="bagian" value="Electric Outfitting">
            ...
            $(function () {
                $( "#namakomp" ).autocomplete({
                    source: function(request, response) {
                        var bagian = "Electric Outfitting";
                        $.ajax({ 
