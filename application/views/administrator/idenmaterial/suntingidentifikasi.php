...
<body onload="firstload()">
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active"><?php echo $bagian;?></li>
                    </ul>
                </div>
                <!-- /Page Breadcrumb -->
                <!-- Page Header -->
                        ...
                        <div class="col-xs-12 col-md-12">
                            <div class="widget">
                                <div class="widget-header ">
                                    <span class="widget-caption">Identifikasi Material <?php echo $bagian;?></span>
                                ...
                                <div class="widget-body">
                                    ...
                                    <div id="horizontal-form">
                                                <form class="form-horizontal" method="post" role="form" enctype="multipart/form-data" action="<?php echo base_url(); ?>idenmat/updatehullcon">
                                                    <div class="form-title" align="center">
                                                        Silahkan Sunting Komponen
                                                    </div>
                                                    <br>
 ...
 -->
                                                    ...
                                                    <div class="form-group">
                                                        <label for="inputEmail3" class="col-sm-3 control-label no-padding-right">Nama Komponen/Outfitting</label>
                                                        <div class="col-sm-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="inputEmail3" class="col-sm-3 control-label no-padding-right">ID Komponen/Outfitting</label>
                                                        <div class="col-sm-6">
                                                    ...
                                                    <div class="form-title" align="center">
                                                        Silahkan Sunting Item Pemeriksaan di bawah ini
                                                    </div>
                                                    <br>
...
<!-- 
                                                    ...
                                                    <br>
                                                    <div class="form-title" align="center">
                                                        Silahkan Sunting Form di Bawah Ini
                                                    </div>
                                                    <br>
                                                    ...
                                                    <input id="id_idenmat" type="hidden" name="id_idenmat"  value="<?php echo $idenparsing;?>" />
                                                    <input id="daftarBarang" type="hidden" name="daftarBarang" />
                                                     ...
                                                     <div class="form-group">
                                                        <div class="col-lg-offset-5 col-lg-8">
                                                            ...
                                                            <input class="btn btn-palegreen" type="submit" onclick="submitval()" value="Update" />
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
    ...
    <script type="text/javascript">
        ...
        function firstload(){
           ...
           $.ajax({
                url: '<?php echo base_url(); ?>ajax/ambilulangiden/',
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        document.getElementById('bagian').value = data[i].bagian;
                        document.getElementById('bagian1').value = data[i].bagian;
                        document.getElementById('namakomp').value = data[i].nama_komp;
                        document.getElementById('idkomp').value = data[i].id_komp;
                        document.getElementById('qcinspec').value = data[i].qc_inspec;
                        document.getElementById('qacoor').value = data[i].qa_coor;
                        document.getElementById('classsur').value = data[i].class_sur;
                        document.getElementById('ownersur').value = data[i].owner_sur;
                        document.getElementById('tanggalperiksa').value = data[i].tgl_periksa;
                        ...
                        if(data[i].status == "Reject"){
                            ...
                            document.getElementById('rein').innerHTML = '<label for="inputEmail3" class="col-sm-3 control-label no-padding-right">Tanggal Re Inspeksi</label><div class="col-sm-6"><input type="text" class="form-control" id="reinspek1" name="reinspek1" value="'+ data[i].tgl_reinspeksi +'" disabled="true"><input type="hidden" class="form-control" id="reinspek" name="reinspek" value="'+ data[i].tgl_reinspeksi +'"></div>';
                            document.getElementById('rekomendasi').innerHTML = '<label for="inputEmail3" class="col-sm-3 control-label no-padding-right">Rekomendasi</label><div class="col-sm-6"><textarea class="form-control" id="rekomendasi" name="rekomendasi" placeholder="Masukkan Rekomendasi">'+ data[i].rekomendasi +'</textarea></div>'; 
                    ...
                    $.ajax({
                        ...
                        success: function(data) {             
                            ...
                            for (var i = 0; i < data.length; i++) {
                                ...
                                var id1 = i + '1';
                                var id2 = i + '2';
                                itemlist[i] = data[i].nama_item;
                                var isi = '<div class="form-group"><label class="col-sm-3 control-label no-padding-right">'+ data[i].nama_item+'</label><div class="col-lg-3"><input type="text" class="form-control" value="'+ data[i].isi_item+'" id="'+ id1 +'" placeholder="isi Item"></div><div class="col-lg-3"><input type="text" class="form-control" value="'+ data[i].standard_item +'" id="'+ id2 +'" placeholder="Standard Item"></div></div> ';
                                $('#itemisi').append(isi);
