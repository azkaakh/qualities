...
<body onload="muatproject()">
                        ...
                        <div class="col-xs-12 col-md-12">
                            <div class="widget">
                                ...
                                <div class="widget-body">
                                    ...
                                    <form id="registrationForm" action="<?php echo base_url(); ?>admin/mainproject" method="post" class="form-horizontal"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <table class="table table-hover">
                                                           ...
                                                           <input id="idparsing" type="hidden" name="idparsing" />
                                                            <input id="user" type="hidden" value="<?php echo $this->session->userdata('pilihan_project');?>" name="user" />
                                                        </table>
    ...
    <script type="text/javascript">
        ...
        function pilih(angka){
            sessionStorage.setItem("pilihan", angka);
            document.getElementById('idparsing').value = sessionStorage.getItem('pilihan');
            $('#form').submit();
        }

        function muatproject(){
            $.ajax({
                url: '<?php echo base_url(); ?>ajax/ambillistproject/',
                data: {},
                dataType: 'json',
                type: 'POST',
                success: function(data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        var isi = '<tr><td>'+data[i].nama_project+'</td><td>'+ data[i].owner+'</td><td>'+ data[i].panjang_kapal+'</td><td>'+ data[i].lebar_kapal+'</td><td>'+ data[i].tinggi_kapal +'</td><td>'+ data[i].sarat_kapal+'</td><td>'+ data[i].launching+'</td><td>'+ data[i].delivery+'</td><td><a class="btn btn-info btn-xs " onclick="lihatdetail('+ data[i].id_project+')" data-toggle="modal" data-target="#myModal"><i class="fa fa-info"></i> Lihat Detail</a> <button class="btn btn-palegreen btn-xs" onclick="pilih('+ data[i].id_project +')"><i class="fa fa-edit"></i> Pilih Project</button></td></tr>';
        ...
        function lihatdetail(id){
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>ajax/ambildetailproject/',
                data: {id:id},
                dataType: 'json',
                type: 'POST',
                success: function(data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        var isi2 = '<tr><td><strong>Nomor Project</strong></td><td>'+ data[i].id_project+'</td></tr><tr><td><strong>Nama Project</strong></td><td>'+ data[i].nama_project+'</td></tr><tr><td><strong>Owner</strong></td><td>'+ data[i].owner+'</td></tr><tr><td><strong>IMO No. / Class</strong></td><td>'+ data[i].imo+'  </td></tr><tr><td><strong>Panjang Kapal</strong></td><td>'+ data[i].panjang_kapal+'</td></tr><tr><td><strong>Lebar Kapal</strong></td><td>'+ data[i].lebar_kapal+' </td></tr><tr><td><strong>Tinggi Kapal</strong></td><td>'+data[i].tinggi_kapal+'</td></tr><tr><td><strong>Sarat Kapal</strong></td><td>'+ data[i].sarat_kapal+' </td></tr><tr><td><strong>GT Flag</strong></td><td>'+data[i].gt_flag+'</td></tr><tr><td><strong>Keel Laying</strong></td><td>'+ data[i].keel_laying+'</td></tr><tr><td><strong>Launching</strong></td><td>'+ data[i].launching +' </td></tr><tr><td><strong>Commissioning Progress</strong></td><td>'+ data[i].comm_prog+' </td></tr><tr><td><strong>Inclining</strong></td><td>'+ data[i].inclining+' </td></tr><tr><td><strong>Sea Trial</strong></td><td>'+ data[i].sea_trial+' </td></tr><tr><td><strong>Delivery</strong></td><td>'+data[i].delivery+' </td></tr><tr><td><strong></strong></td><td></td></tr>';
