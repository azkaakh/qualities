                            ...
                            <div class="widget">
                                ...
                                <div class="widget-body">
                                    ...
                                    <div id="horizontal-form">
                                                <form class="form-horizontal" method="post" role="form" enctype="multipart/form-data" action="<?php echo base_url(); ?>outfitting/submitoutfitting">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="inputEmail3" class="col-sm-3 control-label no-padding-right">Bagian</label>
                                                        <div class="col-sm-8">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input type="text" class="form-control" id="namaoutfitting" name="namaoutfitting" placeholder="Nama Outfitting">                                                         
                                                        </div>
                                                    </div>
...
<!-- 
                                                    ...
                                                    <input id="id_outfitting" type="hidden" name="id_outfitting"  value="<?php echo $id;?>" />
                                                    <input id="daftarBarang" type="hidden" name="daftarBarang" />
                                                     ...
                                                     <div class="form-group">
                                                        <div class="col-lg-offset-5 col-lg-8">
                                                            ...
                                                            <input class="btn btn-palegreen" type="submit" onclick="submitval()" value="Simpan" id="tombol" disabled="true" />
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                    ...
                    <div class="modal-dialog">
                      ...
                      <div class="modal-content">
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title">Penambahan Data Outfitting</h4>
                        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $(function () {
                $( "#namaoutfitting" ).autocomplete({
                    source: function(request, response) {                        
                        var bagian = document.getElementById('bagian').value;
                        var idproj = "<?php echo $this->session->userdata('pilihan_project'); ?>";
                        $.ajax({ 
                            url: "<?php echo base_url(); ?>ajax/ambiloutfitting/",
                            data: { kode: $("#namaoutfitting").val(), bagian:bagian, idproj:idproj},
                            dataType: "json",
                            type: "POST",
                    ...
                    select: function(event, ui){
                        ...
                        var bagian = document.getElementById('bagian').value;
                        $.ajax({
                        url: '<?php echo base_url(); ?>ajax/ambilitemout/',
                        data: {itemselected:itemselected, bagian:bagian},
                        dataType: 'json',
                        type: 'POST',
                        success: function(data) {
                            ...
                            for (var i = 0; i < data.length; i++) {
                                var id1 = i + '1';
                                var id2 = i + '2';
                                itemlist[i] = data[i].item_kompout;
                                var isi = '<div class="form-group"><label class="col-sm-3 control-label no-padding-right">'+ data[i].item_kompout+'</label><div class="col-lg-3"><input type="'+data[i].tipe_dataout  +'" class="form-control" id="'+ id1 +'" placeholder="isi Item"></div><div class="col-lg-3"><input type="'+ data[i].tipe_dataout +'" class="form-control" id="'+ id2 +'" placeholder="Standard Item"></div></div>';
                                $('#itemisi').append(isi);
