                ...
                <?php
                  if($hasil == 'sukses') { ?>
                    ...
                    <div class="alert alert-success fade in" align="center">
                      ...
                      <strong>Sukses</strong> Input Data Outfitting Telah Berhasil
                    </div>
                  <?php } 
                  elseif ($hasil == 'gagal') { ?>
                    <br>
                    <div class="alert alert-danger fade in radius-bordered alert-shadowed">
                        ...
                        <strong>Gagal!</strong> Input Data Outfitting Gagal
                    </div>
                  <?php }
                ?>
                <div class="page-body">
                        ...
                        <div class="col-xs-12 col-md-12">
                            <div class="widget">
                                <div class="widget-header ">
                                    <span class="widget-caption">Tahapan Outfitting</span>
                                ...
                                <div class="widget-body">
                                    ...
                                    <div id="horizontal-form">
                                                <form class="form-horizontal" method="post" role="form" enctype="multipart/form-data" action="<?php echo base_url(); ?>outfitting/updateisioutfitting">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input type="text" class="form-control" id="namaoutfitting1" name="namaoutfitting1" placeholder="Nama Outfitting" disabled="true">
                                                            <input type="hidden" class="form-control" id="namaoutfitting" name="namaoutfitting" placeholder="Nama Outfitting">                                                         
                                                        </div>
                                                    </div>
                                                    ...
                                                    <input id="id_outfitting" type="hidden" name="id_outfitting"  value="<?php echo $idenparsing;?>" />
           ...
           $.ajax({
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        document.getElementById('bagian').value = data[i].nama_bagianout;                        
                        document.getElementById('bagian1').value = data[i].nama_bagianout;                        
                        document.getElementById('namaoutfitting').value = data[i].nama_outfitting;                        
                        document.getElementById('namaoutfitting1').value = data[i].nama_outfitting;
                        document.getElementById('qcinspec').value = data[i].qc_inspecout;
                        document.getElementById('qacoor').value = data[i].qa_coorout;
                        document.getElementById('classsur').value = data[i].class_surout;
                        document.getElementById('ownersur').value = data[i].owner_surout;
                        document.getElementById('tanggalperiksa').value = data[i].tgl_periksaout;
                        document.getElementById('status').value = data[i].status_out;
                        ...
                        if(data[i].status_out == "Reject"){
                            ...
                            document.getElementById('rein').innerHTML = '<label for="inputEmail3" class="col-sm-3 control-label no-padding-right">Tanggal Re Inspeksi</label><div class="col-sm-6"><input type="text" class="form-control" id="reinspek1" name="reinspek1" value="'+ data[i].tgl_reinspekout +'" disabled="true"><input type="hidden" class="form-control" id="reinspek" name="reinspek" value="'+ data[i].tgl_reinspekout +'"></div>';
                            document.getElementById('rekomendasi').innerHTML = '<label for="inputEmail3" class="col-sm-3 control-label no-padding-right">Rekomendasi</label><div class="col-sm-6"><textarea class="form-control" id="rekomendasi" name="rekomendasi" placeholder="Masukkan Rekomendasi">'+ data[i].rekomendasi_out +'</textarea></div>'; 
                    ...
                    $.ajax({
                        ...
                        success: function(data) {             
                            ...
                            for (var i = 0; i < data.length; i++) {
                                ...
                                var id1 = i + '1';
                                var id2 = i + '2';
                                itemlist[i] = data[i].nama_itemout;
                                var isi = '<div class="form-group"><label class="col-sm-3 control-label no-padding-right">'+ data[i].nama_itemout+'</label><div class="col-lg-3"><input type="text" class="form-control" value="'+ data[i].isi_itemout+'" id="'+ id1 +'" placeholder="isi Item"></div><div class="col-lg-3"><input type="text" class="form-control" value="'+ data[i].standard_itemout +'" id="'+ id2 +'" placeholder="Standard Item"></div></div> ';
                                $('#itemisi').append(isi);
