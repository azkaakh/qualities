                            ...
                            <div class="widget">
                                ...
                                <div class="widget-body">
                                    ...
                                    <div id="horizontal-form">
                                                <form class="form-horizontal" method="post" role="form" enctype="multipart/form-data" action="<?php echo base_url(); ?>delivery/updatedelivery">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input type="text" class="form-control" id="namadok1" name="namadok1" placeholder="Nama Dokumen" disabled="true"> 
                                                            <input type="hidden" class="form-control" id="namadok" name="namadok" placeholder="Nama Dokumen">                                                         
                                                        </div>
                                                    </div>
...
<!-- 
                                                    ...
                                                    <input id="id_delivery" type="hidden" name="id_delivery"  value="<?php echo $idenparsing;?>" />
           ...
           $.ajax({
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        document.getElementById('namadok1').value = data[i].nama_dokumen; 
                        document.getElementById('namadok').value = data[i].nama_dokumen;                         
                        document.getElementById('qcinspec').value = data[i].qc_inspecd;
                        document.getElementById('qacoor').value = data[i].qa_coord;
                        document.getElementById('classsur').value = data[i].class_surd;
                        document.getElementById('ownersur').value = data[i].owner_surd;
                        document.getElementById('tanggalperiksa').value = data[i].tgl_periksad;
                        document.getElementById('status').value = data[i].status_delivery;
                        ...
                        if(data[i].status_delivery == "Reject"){
                            ...
                            document.getElementById('rein').innerHTML = '<label for="inputEmail3" class="col-sm-3 control-label no-padding-right">Tanggal Re Inspeksi</label><div class="col-sm-6"><input type="text" class="form-control" id="reinspek1" name="reinspek1" value="'+ data[i].tgl_reinspeksid +'" disabled="true"><input type="hidden" class="form-control" id="reinspek" name="reinspek" value="'+ data[i].tgl_reinspeksid +'"></div>';
                            document.getElementById('rekomendasi').innerHTML = '<label for="inputEmail3" class="col-sm-3 control-label no-padding-right">Rekomendasi</label><div class="col-sm-6"><textarea class="form-control" id="rekomendasi" name="rekomendasi" placeholder="Masukkan Rekomendasi">'+ data[i].rekomendasi_delivery +'</textarea></div>'; 
                    ...
                    $.ajax({
                        ...
                        success: function(data) {             
                            ...
                            for (var i = 0; i < data.length; i++) {
                                ...
                                var id1 = i + '1';
                                var id2 = i + '2';
                                itemlist[i] = data[i].nama_itemd;
                                var isi = '<div class="form-group"><label class="col-sm-3 control-label no-padding-right">'+ data[i].nama_itemd+'</label><div class="col-lg-3"><input type="text" class="form-control" value="'+ data[i].isi_itemd+'" id="'+ id1 +'" placeholder="isi Item"></div><div class="col-lg-3"><input type="text" class="form-control" value="'+ data[i].standard_itemd +'" id="'+ id2 +'" placeholder="Standard Item"></div></div> ';
                                $('#itemisi').append(isi);
