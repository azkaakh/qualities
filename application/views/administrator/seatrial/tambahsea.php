                            ...
                            <div class="widget">
                                ...
                                <div class="widget-body">
                                    ...
                                    <div id="horizontal-form">
                                                <form class="form-horizontal" method="post" role="form" enctype="multipart/form-data" action="<?php echo base_url(); ?>sea/submitsea">
...
<!-- 
                                                    ...
                                                    <input id="idsea" type="hidden" name="idsea"  value="<?php echo $id;?>" />
            ...
            $(function () {
                $( "#namauji" ).autocomplete({
                    source: function(request, response) {                        
                        ...
                        $.ajax({ 
                            url: "<?php echo base_url(); ?>ajax/ambilsea/",
                    ...
                    select: function(event, ui){
                        ...
                        var bagian = document.getElementById('bagian').value;
                        $.ajax({
                        url: '<?php echo base_url(); ?>ajax/ambilitemsea/',
                        ...
                        success: function(data) {
                            ...
                            for (var i = 0; i < data.length; i++) {
                                var id1 = i + '1';
                                var id2 = i + '2';
                                itemlist[i] = data[i].item_sea;
                                var isi = '<div class="form-group"><label class="col-sm-3 control-label no-padding-right">'+ data[i].item_sea+'</label><div class="col-lg-3"><input type="'+data[i].tipe_datas +'" class="form-control" id="'+ id1 +'" placeholder="isi Item"></div><div class="col-lg-3"><input type="'+ data[i].tipe_datas +'" class="form-control" id="'+ id2 +'" placeholder="Standard Item"></div></div>';
                                $('#itemisi').append(isi);
