                ...
                <?php
                  if($hasil == 'sukses') { ?>
                    ...
                    <div class="alert alert-success fade in" align="center">
                      ...
                      <strong>Sukses</strong> Input Data Sea Trial Telah Berhasil
                    </div>
                  <?php } 
                  elseif ($hasil == 'gagal') { ?>
                    <br>
                    <div class="alert alert-danger fade in radius-bordered alert-shadowed">
                        ...
                        <strong>Gagal!</strong> Input Data Sea Trial Gagal
                    </div>
                  <?php }
                ?>
                <div class="page-body">
                        ...
                        <div class="col-xs-12 col-md-12">
                            <div class="widget">
                                <div class="widget-header ">
                                    <span class="widget-caption">Tahapan Sea Trial</span>
                                ...
                                <div class="widget-body">
                                    ...
                                    <div id="horizontal-form">
                                                <form class="form-horizontal" method="post" role="form" enctype="multipart/form-data" action="<?php echo base_url(); ?>sea/updatesea">
...
<!-- 
                                                    ...
                                                    <input id="idsea" type="hidden" name="idsea"  value="<?php echo $idenparsing;?>" />
                    ...
                    <div class="modal-dialog">
                      ...
                      <div class="modal-content">
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title">Penambahan Data Erection</h4>
                        </div>
                        <div class="modal-body">
                          <p>Pastikan Anda telah memasukkan data pada Assembly terlebih dahulu</p>
                        </div>
                ...
                <div class="modal fade" id="off" role="dialog">
                    <div class="modal-dialog">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <p>Data Blok belum ada dalam Database, silahkan isi pada Assembly terlebih dahulu.</p>
                        </div>
                        <div class="modal-footer">
                          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                        </div>
           ...
           $.ajax({
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        document.getElementById('bagian1').value = data[i].bagian_sea; 
                        document.getElementById('bagian').value = data[i].bagian_sea; 
                        document.getElementById('namauji1').value = data[i].pengujian_sea; 
                        document.getElementById('namauji').value = data[i].pengujian_sea; 
                        document.getElementById('idkomp').value = data[i].id_komps;
                        document.getElementById('qcinspec').value = data[i].qc_inspecs;
                        document.getElementById('qacoor').value = data[i].qa_coors;
                        document.getElementById('classsur').value = data[i].class_surs;
                        document.getElementById('ownersur').value = data[i].owner_surs;
                        document.getElementById('tanggalperiksa').value = data[i].tgl_periksas;
                        document.getElementById('status').value = data[i].status_sea;
                        ...
                        if(data[i].status_sea == "Reject"){
                            ...
                            document.getElementById('rein').innerHTML = '<label for="inputEmail3" class="col-sm-3 control-label no-padding-right">Tanggal Re Inspeksi</label><div class="col-sm-6"><input type="text" class="form-control" id="reinspek1" name="reinspek1" value="'+ data[i].tgl_reinspeksis +'" disabled="true"><input type="hidden" class="form-control" id="reinspek" name="reinspek" value="'+ data[i].tgl_reinspeksis +'"></div>';
                            document.getElementById('rekomendasi').innerHTML = '<label for="inputEmail3" class="col-sm-3 control-label no-padding-right">Rekomendasi</label><div class="col-sm-6"><textarea class="form-control" id="rekomendasi" name="rekomendasi" placeholder="Masukkan Rekomendasi">'+ data[i].rekomendasi_sea +'</textarea></div>'; 
                    ...
                    $.ajax({
                        ...
                        success: function(data) {             
                            ...
                            for (var i = 0; i < data.length; i++) {
                                ...
                                var id1 = i + '1';
                                var id2 = i + '2';
                                itemlist[i] = data[i].nama_items;
                                var isi = '<div class="form-group"><label class="col-sm-3 control-label no-padding-right">'+ data[i].nama_items+'</label><div class="col-lg-3"><input type="text" class="form-control" value="'+ data[i].isi_items+'" id="'+ id1 +'" placeholder="isi Item"></div><div class="col-lg-3"><input type="text" class="form-control" value="'+ data[i].standard_items +'" id="'+ id2 +'" placeholder="Standard Item"></div></div> ';
                                $('#itemisi').append(isi);
