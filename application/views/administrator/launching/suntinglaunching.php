                ...
                <?php
                  if($hasil == 'sukses') { ?>
                    ...
                    <div class="alert alert-success fade in" align="center">
                      ...
                      <strong>Sukses</strong> Input Data Launching Telah Berhasil
                    </div>
                  <?php } 
                  elseif ($hasil == 'gagal') { ?>
                    <br>
                    <div class="alert alert-danger fade in radius-bordered alert-shadowed">
                        ...
                        <strong>Gagal!</strong> Input Data Launching Gagal
                    </div>
                  <?php }
                ?>
                <div class="page-body">
                        ...
                        <div class="col-xs-12 col-md-12">
                            <div class="widget">
                                <div class="widget-header ">
                                    <span class="widget-caption">Tahapan Launching</span>
                                ...
                                <div class="widget-body">
                                    ...
                                    <div id="horizontal-form">
                                                <form class="form-horizontal" method="post" role="form" enctype="multipart/form-data" action="<?php echo base_url(); ?>launching/updateisilaunching">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input type="text" class="form-control" id="namakomp1" name="namakomp1" placeholder="Nama Komponen" disabled="true">
                                                            <input type="hidden" class="form-control" id="namakomp" name="namakomp" placeholder="Nama Komponen">                                                         
                                                        </div>
                                                    </div>
...
<!-- 
                                                    ...
                                                    <input id="idlau" type="hidden" name="idlau"  value="<?php echo $idenparsing;?>" />
           ...
           $.ajax({
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        document.getElementById('bagian1').value = data[i].bagian_launching; 
                        document.getElementById('bagian').value = data[i].bagian_launching;
                        document.getElementById('namakomp1').value = data[i].nama_kompl; 
                        document.getElementById('namakomp').value = data[i].nama_kompl; 
                        document.getElementById('idkomp').value = data[i].id_kompl;
                        document.getElementById('qcinspec').value = data[i].qc_inspecl;
                        document.getElementById('qacoor').value = data[i].qa_coorl;
                        document.getElementById('classsur').value = data[i].class_surl;
                        document.getElementById('ownersur').value = data[i].owner_surl;
                        document.getElementById('tanggalperiksa').value = data[i].tgl_periksal;
                        document.getElementById('status').value = data[i].status_launching;
                        ...
                        if(data[i].status_launching == "Reject"){
                            ...
                            document.getElementById('rein').innerHTML = '<label for="inputEmail3" class="col-sm-3 control-label no-padding-right">Tanggal Re Inspeksi</label><div class="col-sm-6"><input type="text" class="form-control" id="reinspek1" name="reinspek1" value="'+ data[i].tgl_reinspeksil +'" disabled="true"><input type="hidden" class="form-control" id="reinspek" name="reinspek" value="'+ data[i].tgl_reinspeksil +'"></div>';
                            document.getElementById('rekomendasi').innerHTML = '<label for="inputEmail3" class="col-sm-3 control-label no-padding-right">Rekomendasi</label><div class="col-sm-6"><textarea class="form-control" id="rekomendasi" name="rekomendasi" placeholder="Masukkan Rekomendasi">'+ data[i].rekomendasi_lau +'</textarea></div>'; 
                    ...
                    $.ajax({
                        ...
                        success: function(data) {             
                            ...
                            for (var i = 0; i < data.length; i++) {
                                ...
                                var id1 = i + '1';
                                var id2 = i + '2';
                                itemlist[i] = data[i].nama_iteml;
                                var isi = '<div class="form-group"><label class="col-sm-3 control-label no-padding-right">'+ data[i].nama_iteml+'</label><div class="col-lg-3"><input type="text" class="form-control" value="'+ data[i].isi_iteml+'" id="'+ id1 +'" placeholder="isi Item"></div><div class="col-lg-3"><input type="text" class="form-control" value="'+ data[i].standar_iteml +'" id="'+ id2 +'" placeholder="Standard Item"></div></div> ';
                                $('#itemisi').append(isi);
