...
--
-- Host: 127.0.0.1
-- Generation Time: 31 Jan 2016 pada 05.08
-- Versi Server: 5.6.26
-- PHP Version: 5.5.28
...
INSERT INTO `assembly` (`id_project`, `id_assembly`, `proses_assembly`, `blok_assembly`, `qc_inspecass`, `qa_coorass`, `class_surass`, `owner_surass`, `tgl_periksaass`, `status_assembly`, `tgl_reinspeksiass`, `rekomendasi_assembly`, `path_gambarass`) VALUES
(2, 1, 'Deformasi', 'Blok ABCD', 'A', 'S', 'D', 'F', '2016-01-29', 'OK', '2001-01-01', 'null', 'upload/assembly/logologin.png'),
(2, 2, 'Fitting', 'Blok Cakep', 'pp', 'oo', 'ii', 'uu', '2016-01-29', 'OK', '2001-01-01', 'null', 'upload/assembly/logonew1.png'),
(2, 3, 'Fitting', 'Blok Tesajasih', 'Budi', 'Ninik', 'Mimin', 'Lala', '2016-01-23', 'OK', '2001-01-01', 'null', 'upload/assembly/kata.png');
...
--
-- Dumping data untuk tabel `commissioning`
--

INSERT INTO `commissioning` (`id_project`, `id_comm`, `bagian_comm`, `pengujian_comm`, `id_kompom`, `qc_inspecom`, `qa_coorom`, `class_surom`, `owner_surom`, `tgl_periksaom`, `status_comm`, `tgl_reinspeksiom`, `rekomendasi_comm`, `path_gambarom`) VALUES
(2, 1, 'Hull Construction', NULL, 'D123456', 'aass', 'dd', 'ff', 'gg', '2016-01-28', 'OK', '2001-01-01', 'null', 'upload/launching/logonew1.png'),
(2, 2, 'Machinery Outfitting', NULL, 'DB123', 'a', 's', 'd', 'f', '2016-01-29', 'OK', '2001-01-01', 'null', 'upload/launching/logologin.png'),
(2, 3, 'Hull Construction', 'Main Dmension', 'DB1234', 'a2', 's2', 'd2', 'f2', '2016-01-30', 'OK', '2001-01-01', 'null', 'upload/comm/kata.png'),
(2, 4, 'Hull Construction', 'Main Dmension', 'MD212', 'Popow', 'Ika W', 'Ujik', 'Yoyo', '2016-01-29', 'OK', '2001-01-01', 'null', 'upload/comm/logologin1.png');
...
INSERT INTO `data_project` (`id_project`, `nama_project`, `owner`, `imo`, `panjang_kapal`, `lebar_kapal`, `tinggi_kapal`, `sarat_kapal`, `gt_flag`, `keel_laying`, `launching`, `comm_prog`, `inclining`, `sea_trial`, `delivery`) VALUES
(1, 'Project Kapal Titanic', 'Si Su Si', 'Class B', '250 m', '250 m', '250 m', '4 m', 'Flag B', '2016-01-16', '2016-01-17', '2016-11-18', '2016-01-19', '2016-01-20', '2016-01-21'),
(2, 'Project kapal coba dulu', 'Si Komo hahahihi', 'Class ABCDE', '250 m', '100 m', '30 m', '400 ton', 'True bro', '2016-01-16', '2016-01-17', '2016-11-18', '2016-01-19', '2016-01-20', '2016-01-31');
...
INSERT INTO `delivery` (`id_project`, `id_delivery`, `nama_dokumen`, `qc_inspecd`, `qa_coord`, `class_surd`, `owner_surd`, `tgl_periksad`, `status_delivery`, `tgl_reinspeksid`, `rekomendasi_delivery`, `path_gambard`) VALUES
(2, 1, 'Builder Certificate', 'asdf', 'ssdf', 'dsdf', 'fsdf', '2016-01-29', 'OK', '2001-01-01', 'null', 'upload/delivery/persegipanjang.JPG'),
(2, 2, 'International Sewage Pollution Prevention Certificate', 'Andi', 'Budi', 'Cici', 'Didi', '2016-01-22', 'Reject', '2016-02-19', 'Cek lagi, kemaren salah input', 'upload/delivery/kata.png'),
(2, 3, 'Call Sign', 'Zaenuri', 'Yanuar', 'Xaverius', 'Vanny', '2016-01-29', 'Reject', '2016-02-19', 'Oke Bisa', 'upload/delivery/kata.png'),
(2, 4, 'Cargo Ship Safety Construction Certificate', 'Gigi', 'Fani', 'Dodi', 'Susi', '2016-01-29', 'OK', '2001-01-01', 'null', 'upload/delivery/coba.png'),
(2, 5, 'Inmarsat C', 'zizi', 'adi', 'qeqe', 'wik', '2016-01-30', 'OK', '2001-01-01', 'null', 'upload/delivery/Screenshot_2015-11-19-00-38-28.jpg');
...
--
-- Dumping data untuk tabel `erection`
--

INSERT INTO `erection` (`id_project`, `id_erection`, `proses_erection`, `blok_erection`, `qc_inspecer`, `qa_coorer`, `class_surrer`, `owner_surer`, `tgl_periksaer`, `status_erection`, `tgl_reinspeksier`, `rekomendasi_erection`, `path_gambarer`) VALUES
(2, 1, 'Deformasi', 'Blok ABCDEFGH', 'qwer', 'wwer', 'ewer', 'rwer', '2016-01-23', 'OK', '2001-01-01', 'null', 'upload/erection/persegipanjang.JPG'),
(2, 2, 'Fitting', 'Blok Tesajasih', 'agung hercules', 'susi similikiti', 'dudu dagelan', 'fifi komariyah', '2016-01-29', 'OK', '2001-01-01', 'null', 'upload/erection/logonew1.png');
...
--
-- Dumping data untuk tabel `fabrikasi`
--

INSERT INTO `fabrikasi` (`id_project`, `id_fabrikasi`, `bagian_fabrikasi`, `proses_fabrikasi`, `jenis_fabrikasi`, `nama_kompfab`, `id_kompfab`, `qc_inspecfab`, `qa_coorfab`, `class_surfab`, `owner_surfab`, `tgl_periksafab`, `status_fab`, `tgl_reinspeksifab`, `rekomendasi_fab`, `path_gambarfab`) VALUES
(2, 1, 'Hull Construction', 'Deformasi', 'Pipe', 'Pipa Okepunya', 'PO123', 'AAAAAABBB', 'SSSSSSSBBB', 'DDDDDBBB', 'FFFFFFBBB', '2016-01-30', 'Reject', '2016-02-10', 'cepet dong ya', 'upload/fabrikasi/legenda.png'),
(2, 2, 'Hull Outfitting', 'Deformasi', 'none', 'Chain Stoper', 'CS45', 'budis', 'gigis', 'titis', 'riris', '2016-01-30', 'OK', '2001-01-01', 'null', 'upload/fabrikasi/logonew1.png');
...
--
-- Dumping data untuk tabel `idenmaterial`
--

INSERT INTO `idenmaterial` (`id_project`, `id_idenmat`, `bagian`, `jenis_komp`, `nama_komp`, `id_komp`, `qc_inspec`, `qa_coor`, `class_sur`, `owner_sur`, `tgl_periksa`, `status`, `tgl_reinspeksi`, `rekomendasi`, `path_gambar`) VALUES
(1, 1, 'Hull Construction', 'Pipa', 'aa', 'aa', 'a', 'a', 'a', 'a', '2016-01-28', 'OK', '2001-01-01', 'null', 'upload/idenmat/hull/Use_CAse_Diagram.jpg'),
(1, 2, 'Hull Construction', 'Pipa', 'Pipa Pemadam Kebakaran', '311', 'Rikoaaa', 'Anggeraaa', 'Eriaaa', 'Aryaaaa', '2016-01-28', 'Reject', '2016-02-16', 'Cepat ya di periksa lagi aaa', 'upload/idenmat/hull/Screenshot_(1).png'),
(1, 3, 'Hull Construction', 'Pelat', 'asd', 'asd', 'aaa', 'aaa', 'aaa', 'aaa', '2016-01-27', 'OK', '2001-01-01', 'null', 'upload/idenmat/hull/DFD.jpg'),
(1, 4, 'Hull Construction', 'Pipa', 'Pipa Ledeng Air Laut', 'L001ABC', 'Anggeriko', 'Riko Arya', 'Arya Sena', 'Sena Angger', '2016-01-28', 'Reject', '2016-02-11', 'Cepet buruan diperiksa ya, udah mepet banget, mepet deadline', 'upload/idenmat/hull/Screenshot_(12).png'),
(1, 5, 'Hull Construction', 'Pelat', 'Pelat Baja', 'BJ001', 'Petugas', 'Petugas', 'Petugas', 'Petugas', '2016-01-21', 'OK', '2001-01-01', 'null', 'upload/idenmat/hull/Screenshot_(36).png'),
(1, 6, 'Hull Construction', 'Pipa', 'Pipa Tes terakhir', '213', 'AA', 'AA', 'AA', 'AA', '2016-01-22', 'Reject', '2016-02-18', 'Periksa lagi', 'upload/idenmat/hull/Screenshot_(34).png'),
(1, 7, 'Hull Construction', 'Pipa', 'Pipa Paralon', 'PR123', 'AA', 'AA', 'AA', 'AA', '2016-01-22', 'Reject', '2016-02-13', 'Cepet', 'upload/idenmat/hull/Screenshot_(64).png'),
(1, 8, 'Machinery Outfitting', 'none', 'Stern Tube Bushing', 'ST12', 'Riko', 'Arya', 'Sena', 'Angger', '2016-01-21', 'Reject', '2016-02-13', 'Periksa Cepet', 'upload/idenmat/hull/Login.png'),
(1, 9, 'Hull Outfitting', 'none', 'Rudder blade', 'RB123', 'Anggeriko', 'Arya', 'Sena', 'Riko', '2016-01-30', 'Reject', '2016-02-18', 'Cepet Periksa', 'upload/idenmat/hull/pembatasn.png'),
(1, 10, 'Electric Outfitting', 'none', 'Main Lighting System', 'ML123', 'Riko', 'Riko Arya', 'Angger', 'Arya', '2016-01-23', 'OK', '2001-01-01', 'null', 'upload/idenmat/hull/Banknotes-32.png'),
(1, 11, 'Electric Outfitting', 'none', 'Main Switch Board (MSB)', 'MS12', 'AA', 'AA', 'AA', 'AA', '2016-01-29', 'OK', '2001-01-01', 'null', 'upload/idenmat/hull/485808_402777379789080_1873850741_n.jpg'),
(2, 12, 'Hull Construction', 'Pipa', 'Pipa Okepunya', 'PO123', 'AA', 'BB', 'CC', 'DD', '2016-01-29', 'OK', '2001-01-01', 'null', 'upload/idenmat/hull/UC.jpg'),
(2, 13, 'Machinery Outfitting', 'none', 'After Boss Casting', 'AB12', 'Vivi', 'Cici', 'Didi', 'Fifi', '2016-01-30', 'Reject', '2016-02-20', 'Harus cepat dikerjakan', 'upload/idenmat/hull/logonew1.png'),
(2, 14, 'Hull Outfitting', 'none', 'Chain Stoper', 'CS12', 'Jono', 'Koko', 'Lili', 'Momon', '2016-01-30', 'OK', '2001-01-01', 'null', 'upload/idenmat/hull/logonew1.png');
...
CREATE TABLE IF NOT EXISTS `item_assembly` (
  `id_assembly` int(11) NOT NULL,
  `id_itemassembly` int(11) NOT NULL,
...
--
-- Dumping data untuk tabel `item_assembly`
--

INSERT INTO `item_assembly` (`id_assembly`, `id_itemassembly`, `nama_itemas`, `isi_itemas`, `standard_itemas`) VALUES
(1, 1, 'Kerataan Pelat antara gading - gading', '22', '22'),
(1, 2, 'Kerataan Pelat di tepi bebas', '22', '22'),
(2, 3, 'Kesalahan Pemasangan', 'no', 'no'),
(2, 4, 'Belum Terpasang', 'no', 'no'),
(2, 5, 'Ketidaklurusan', '10', '10'),
(2, 6, 'Celah/Gap', '10', '10'),
(3, 7, 'Kesalahan Pemasangan', 'gak ada sih', 'gak ada sih'),
(3, 8, 'Belum Terpasang', 'gak ada aja', 'gak ada aja'),
(3, 9, 'Ketidaklurusan', '1', '1'),
(3, 10, 'Celah/Gap', '2', '2');
...
--
-- Dumping data untuk tabel `item_comm`
--

INSERT INTO `item_comm` (`id_comm`, `id_itemcomm`, `nama_itemom`, `isi_itemom`, `standard_itemom`) VALUES
(1, 1, 'Measurement Test (LOA, LPP, B, H)', '1', '1'),
(2, 2, 'Function test', 's', 's'),
(3, 3, 'Measurement Test (LOA, LPP, B, H)', 'errrr', 'rrrre'),
(4, 4, 'Measurement Test (LOA, LPP, B, H)', '212', '212');
...
--
-- Dumping data untuk tabel `item_delivery`
--

INSERT INTO `item_delivery` (`id_delivery`, `id_itemd`, `nama_itemd`, `isi_itemd`, `standard_itemd`) VALUES
(1, 1, 'Completion', 'afqqq', 'afqqq'),
(1, 2, 'No Certificate', 'afqq', 'afqq'),
(1, 3, 'Issued By', 'afq', 'afq'),
(2, 4, 'Completion', 'gagal', 'gagal'),
(2, 5, 'No Certificate', 'gagal', 'gagal'),
(2, 6, 'Issued By', 'gagal', 'gagal'),
(3, 7, 'Completion', 'bisa', 'bisa'),
(3, 8, 'No Certificate', 'bisa', 'bisa'),
(3, 9, 'Issued By', 'bisa', 'bisa'),
(4, 10, 'Completion', 'sip', 'oke'),
(4, 11, 'No Certificate', 'sip', 'oke'),
(4, 12, 'Issued By', 'sip', 'oke'),
(5, 13, 'Completion', 'tes', 'tes'),
(5, 14, 'No Certificate', 'tes', 'tes'),
(5, 15, 'Issued By', 'tes', 'tes');
...
--
-- Dumping data untuk tabel `item_erection`
--

INSERT INTO `item_erection` (`id_erection`, `id_itemer`, `nama_itemer`, `isi_itemer`, `standard_itemer`) VALUES
(1, 1, 'Kerataan Pelat antara gading - gading', '21', '21'),
(1, 2, 'Kerataan Pelat di tepi bebas', '21', '21'),
(2, 3, 'Kesalahan Pemasangan', 'tidak ada', 'tidak ada'),
(2, 4, 'Belum Terpasang', 'tidaks', 'tidaks'),
(2, 5, 'Ketidaklurusan', '0', '0'),
(2, 6, 'Celah/Gap', '1', '1');
...
--
-- Dumping data untuk tabel `item_fabrikasi`
--

INSERT INTO `item_fabrikasi` (`id_fabrikasi`, `id_item`, `nama_itemfab`, `isi_itemfab`, `standard_itemfab`) VALUES
(1, 1, 'Distorsi Pelat dan Profil', '2121', '1221'),
(1, 2, 'Distorsi pada sambungan pelat akibat pengelasan', '1221', '1221'),
(2, 3, 'Distorsi Pipa', '211', '211');
...
(1, 1, 'Ukuran Pipa', 'aa', 'a'),
(1, 2, 'Visual Check', 'aa', 'a'),
(1, 3, 'Quantity', '2', '2'),
(1, 4, 'Grade/Type', 'a', 'a'),
(1, 5, 'Nomor Sertifikat', 'a', 'a'),
(1, 6, 'Tanggal Produksi', '2016-01-29', '2016-01-30'),
(2, 7, 'Ukuran Pipa', '100 m', '100 m'),
(2, 8, 'Visual Check', 'okeaaaa', 'okeaaa'),
(2, 9, 'Quantity', '5', '5'),
(2, 10, 'Grade/Type', 'Grade Aaaa', 'Grade Aaaa'),
(2, 11, 'Nomor Sertifikat', '12345ABCDaaa', '12345ABCDaaa'),
(2, 12, 'Tanggal Produksi', '2016-01-29', '2016-01-29'),
(3, 13, 'Ukuran Pelat', 'sad', 'asd'),
(3, 14, 'Visual Check', 'asd', 'asd'),
(3, 15, 'Quantity', '11', '11'),
(3, 16, 'Grade/Type', 'asd', 'asd'),
(3, 17, 'Nomor Sertifikat', 'asd', 'asd'),
(3, 18, 'Tanggal Produksi', '2016-01-22', '2016-01-29'),
(4, 19, 'Tanggal Produksi', '2016-01-27', '2016-01-29'),
(4, 20, 'Tanggal Produksi', '2016-01-27', '2016-01-29'),
(4, 21, 'Tanggal Produksi', '2016-01-27', '2016-01-29'),
(4, 22, 'Tanggal Produksi', '2016-01-27', '2016-01-29'),
(4, 23, 'Tanggal Produksi', '2016-01-27', '2016-01-29'),
(4, 24, 'Tanggal Produksi', '2016-01-27', '2016-01-29'),
(5, 31, 'Ukuran Pelat', '100 m', '100 m'),
(5, 32, 'Visual Check', 'Oke', 'oke'),
(5, 33, 'Quantity', '3', '3'),
(5, 34, 'Grade/Type', 'AB', 'AB'),
(5, 35, 'Nomor Sertifikat', 'BJ1234', 'BJ1234'),
(5, 36, 'Tanggal Produksi', '2016-01-14', '2016-01-14'),
...
--
-- Dumping data untuk tabel `item_launching`
--

INSERT INTO `item_launching` (`id_launching`, `id_itemlau`, `nama_iteml`, `isi_iteml`, `standar_iteml`) VALUES
(1, 1, 'Fitting ', 'qwerasda', 'qweradsfa'),
(1, 2, 'Welding Check', 'asdfasdfa', 'asdfasdfa'),
(2, 3, 'Fitting ', 'ada', 'ada'),
(2, 4, 'Welding Check', 'ada', 'ada');
...
--
-- Dumping data untuk tabel `item_outfitting`
--

INSERT INTO `item_outfitting` (`id_outfitting`, `id_itemout`, `nama_itemout`, `isi_itemout`, `standard_itemout`) VALUES
(1, 1, 'Cleaning Check before poring Loctite', 'AAAsd', 'AAAsd'),
(1, 2, 'Alignment Check Sighting Shaft Center Before Cpouring Loctite', 'AAAsd', 'AAAsd'),
(2, 3, 'Cleaning Check before poring Loctite', 'sipdeh', 'sipdeh'),
(2, 4, 'Alignment Check Sighting Shaft Center Before Cpouring Loctite', 'sip', 'dip');
...
--
-- Dumping data untuk tabel `item_sea`
--

INSERT INTO `item_sea` (`id_sea`, `id_itemsea`, `nama_items`, `isi_items`, `standard_items`) VALUES
(1, 1, 'Deviasi', '123456', '123456'),
(2, 2, 'Measurement Frequency', '22', '22');
...
CREATE TABLE IF NOT EXISTS `komponen_fabrikasi` (
  `id_kompfabrikasi` int(11) NOT NULL,
  `bagian_fabrikasi` varchar(100) DEFAULT NULL,
  `proses_fabrikasi` varchar(100) DEFAULT NULL,
  `item_fabrikasi` varchar(100) DEFAULT NULL,
  `tipe_datafabrikasi` varchar(100) DEFAULT NULL
) ENGINE=InnoDB AUTO_INCREMENT=76 DEFAULT CHARSET=latin1 COMMENT='komponen_fabrikasi';
...
--
-- Dumping data untuk tabel `launching`
--

INSERT INTO `launching` (`id_project`, `id_launching`, `bagian_launching`, `nama_kompl`, `id_kompl`, `qc_inspecl`, `qa_coorl`, `class_surl`, `owner_surl`, `tgl_periksal`, `status_launching`, `tgl_reinspeksil`, `rekomendasi_lau`, `path_gambarl`) VALUES
(2, 1, 'Machinery Outfitting', 'Anode', 'AN123', 'aaqqqa', 'ssqqqa', 'ddqqa', 'ffqqqa', '2016-01-25', 'OK', '2001-01-01', 'null', 'upload/launching/persegipanjang.JPG'),
(2, 2, 'Machinery Outfitting', 'Anode', 'AD123', 'Yoyok', 'Herman', 'Najmi', 'Budi', '2016-01-30', 'OK', '2001-01-01', 'null', 'upload/launching/logologin1.png');
...
--
-- Dumping data untuk tabel `outfitting`
--

INSERT INTO `outfitting` (`id_project`, `id_outfitting`, `nama_bagianout`, `nama_outfitting`, `qc_inspecout`, `qa_coorout`, `class_surout`, `owner_surout`, `tgl_periksaout`, `status_out`, `tgl_reinspekout`, `rekomendasi_out`, `path_gambarout`) VALUES
(2, 1, 'Machinery Outfitting', 'AFT STERN TUBE SEAL', 'AAsd', 'SSsd', 'DDsd', 'FFsd', '2016-01-29', 'OK', '2001-01-01', 'null', 'upload/erection/nikahgratis.jpg'),
(2, 2, 'Machinery Outfitting', 'AFT STERN TUBE SEAL', 'Ruri', 'Toni', 'Eri', 'Winda', '2016-01-30', 'OK', '2001-01-01', 'null', 'upload/outfitting/logonew1.png');
...
INSERT INTO `pendaftar` (`id_pendaftar`, `username_daftar`, `password_daftar`, `nama_daftar`, `no_telp`, `jabatanposisi`, `alamat`, `nik`, `tipe_kapal`, `no_project`, `infopesan`, `tipe_pengguna`, `status`) VALUES
(1, 'ikoganteng', 'ikoganteng', 'Anggeriko Aryasena', '123456778', 'PT Maju Jaya', 'Jalan Maju Jaya No 16', 'none', 'Pesiar', '2', 'Saya pemilik asli kapal ini', 2, 'SETUJU'),
(2, 'ikoarya', 'ikoarya', 'Iko Arya', '0987654321', 'Quality Assurance', 'none', '09387463728', 'none', '0', 'Saya dari departemen Quality Assurance Pak', 3, 'SETUJU'),
(3, 'test', 'test', 'coba tes', '0234567', 'PT TES', 'jalan Tes', 'none', 'Kapal Tes', '3', 'Tes dulu', 2, 'BELUM SETUJU'),
(4, 'adminganteng', 'adminganteng', 'Admin Ganteng', '087694847289', 'Administrator', 'none', '099218374381234', 'none', '0', 'Admin setuju kok', 1, 'BELUM SETUJU'),
(6, 'tesadmin', 'tesadmin', 'tesadmin', '09384827582', 'Administrator', 'none', '9321482349124', 'none', '0', 'tes admin', 1, 'BELUM SETUJU'),
(8, 'tessekali', 'tessekali', 'tes sekali', '3245245243523', 'Administrator', 'none', '3124151439451', 'none', '0', 'tes sekali', 1, 'BELUM SETUJU');
...
(6, 'ikoganteng', 'ikoganteng', 'Anggeriko Aryasena', 2, '2'),
(7, 'ikoarya', 'ikoarya', 'Iko Arya', 3, '0');
...
--
-- Dumping data untuk tabel `seatrial`
--

INSERT INTO `seatrial` (`id_project`, `id_sea`, `bagian_sea`, `pengujian_sea`, `id_komps`, `qc_inspecs`, `qa_coors`, `class_surs`, `owner_surs`, `tgl_periksas`, `status_sea`, `tgl_reinspeksis`, `rekomendasi_sea`, `path_gambars`) VALUES
(2, 1, 'Hull Outfitting', 'Compass Adjusment', '1', 'aa', 'ss', 'dd', 'ff', '2016-01-29', 'OK', '2001-01-01', 'null', 'upload/seatrial/logonew1.png'),
(2, 2, 'Hull Construction', 'Vibration Measurement', 'VM1', 'Tutis', 'Yesi Irawati', 'Uni', 'Ira', '2016-01-29', 'OK', '2001-01-01', 'null', 'upload/seatrial/logonew1.png');
...
--
-- Indexes for table `commissioning`
--
...
--
-- Indexes for table `erection`
--
ALTER TABLE `erection`
  ADD PRIMARY KEY (`id_erection`);
...
--
-- Indexes for table `idenmaterial`
--
ALTER TABLE `idenmaterial`
  ADD PRIMARY KEY (`id_idenmat`);

--
-- Indexes for table `item_assembly`
--
ALTER TABLE `item_assembly`
  ADD PRIMARY KEY (`id_itemassembly`);

--
-- Indexes for table `item_comm`
--
ALTER TABLE `item_comm`
  ADD PRIMARY KEY (`id_itemcomm`);

--
-- Indexes for table `item_delivery`
--
ALTER TABLE `item_delivery`
  ADD PRIMARY KEY (`id_itemd`);

--
-- Indexes for table `item_erection`
--
ALTER TABLE `item_erection`
  ADD PRIMARY KEY (`id_itemer`);

--
-- Indexes for table `item_fabrikasi`
--
ALTER TABLE `item_fabrikasi`
  ADD PRIMARY KEY (`id_item`);

--
-- Indexes for table `item_idenmat`
--
ALTER TABLE `item_idenmat`
  ADD PRIMARY KEY (`id_item`);

--
-- Indexes for table `item_launching`
--
ALTER TABLE `item_launching`
  ADD PRIMARY KEY (`id_itemlau`);

--
-- Indexes for table `item_outfitting`
--
ALTER TABLE `item_outfitting`
  ADD PRIMARY KEY (`id_itemout`);

--
-- Indexes for table `item_sea`
--
ALTER TABLE `item_sea`
  ADD PRIMARY KEY (`id_itemsea`);

--
-- Indexes for table `komponen_assembly`
--
ALTER TABLE `komponen_assembly`
  ADD PRIMARY KEY (`id_kompassem`);

--
-- Indexes for table `komponen_comm`
--
ALTER TABLE `komponen_comm`
  ADD PRIMARY KEY (`id_kompc`);

--
-- Indexes for table `komponen_delivery`
--
ALTER TABLE `komponen_delivery`
  ADD PRIMARY KEY (`id_dokumen`);

--
-- Indexes for table `komponen_erection`
--
ALTER TABLE `komponen_erection`
  ADD PRIMARY KEY (`id_itemer`);

--
-- Indexes for table `komponen_fabrikasi`
--
ALTER TABLE `komponen_fabrikasi`
  ADD PRIMARY KEY (`id_kompfabrikasi`);

--
-- Indexes for table `komponen_idenmat`
--
ALTER TABLE `komponen_idenmat`
  ADD PRIMARY KEY (`id_komponen`);

--
-- Indexes for table `komponen_launching`
--
ALTER TABLE `komponen_launching`
  ADD PRIMARY KEY (`id_komplau`);

--
-- Indexes for table `komponen_outfitting`
--
ALTER TABLE `komponen_outfitting`
  ADD PRIMARY KEY (`id_kompout`);

--
-- Indexes for table `komponen_sea`
--
ALTER TABLE `komponen_sea`
  ADD PRIMARY KEY (`id_komps`);

--
-- Indexes for table `launching`
--
ALTER TABLE `launching`
  ADD PRIMARY KEY (`id_launching`);

--
-- Indexes for table `outfitting`
--
ALTER TABLE `outfitting`
  ADD PRIMARY KEY (`id_outfitting`);
...
--
-- Indexes for table `seatrial`
--
ALTER TABLE `seatrial`
...
--
-- AUTO_INCREMENT for table `commissioning`
--
ALTER TABLE `commissioning`
...
--
ALTER TABLE `fabrikasi`
  MODIFY `id_fabrikasi` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `idenmaterial`
--
ALTER TABLE `idenmaterial`
  MODIFY `id_idenmat` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=15;
--
-- AUTO_INCREMENT for table `item_assembly`
--
ALTER TABLE `item_assembly`
  MODIFY `id_itemassembly` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `item_comm`
--
ALTER TABLE `item_comm`
  MODIFY `id_itemcomm` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `item_delivery`
--
ALTER TABLE `item_delivery`
  MODIFY `id_itemd` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=16;
--
-- AUTO_INCREMENT for table `item_erection`
--
ALTER TABLE `item_erection`
  MODIFY `id_itemer` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `item_fabrikasi`
--
ALTER TABLE `item_fabrikasi`
  MODIFY `id_item` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `item_idenmat`
--
ALTER TABLE `item_idenmat`
  MODIFY `id_item` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=85;
--
-- AUTO_INCREMENT for table `item_launching`
--
ALTER TABLE `item_launching`
  MODIFY `id_itemlau` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `item_outfitting`
--
ALTER TABLE `item_outfitting`
  MODIFY `id_itemout` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `item_sea`
--
ALTER TABLE `item_sea`
  MODIFY `id_itemsea` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `komponen_assembly`
--
ALTER TABLE `komponen_assembly`
  MODIFY `id_kompassem` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=24;
--
-- AUTO_INCREMENT for table `komponen_delivery`
--
ALTER TABLE `komponen_delivery`
  MODIFY `id_dokumen` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=32;
--
-- AUTO_INCREMENT for table `komponen_erection`
--
ALTER TABLE `komponen_erection`
  MODIFY `id_itemer` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=35;
--
-- AUTO_INCREMENT for table `komponen_fabrikasi`
--
ALTER TABLE `komponen_fabrikasi`
  MODIFY `id_kompfabrikasi` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=76;
--
-- AUTO_INCREMENT for table `komponen_idenmat`
--
ALTER TABLE `komponen_idenmat`
  MODIFY `id_komponen` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=211;
--
-- AUTO_INCREMENT for table `komponen_launching`
--
ALTER TABLE `komponen_launching`
  MODIFY `id_komplau` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=38;
--
-- AUTO_INCREMENT for table `komponen_sea`
--
ALTER TABLE `komponen_sea`
  MODIFY `id_komps` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=50;
--
